...
pickle_in = open("dt_clf_ccp.pkl","rb")
dt_clf_ccp.pkl=pickle.load(pickle_in)
...
def predict_custom_churn(age,duration,quarterly_indicator):
    ...
    prediction=rfmode.predict([[age,duration,quarterly_indicator]])
    print(prediction)
    return prediction
...
def main():
    ...
    if st.button("Predict"):
        result=predict_custom_churn(age,duration,quarterly_indicator)
